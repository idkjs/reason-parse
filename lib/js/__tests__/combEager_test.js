...
function trim(p) {
  return Comb$ReasonParse.between(RegExp$ReasonParse.maybeWhitespace, p, RegExp$ReasonParse.maybeWhitespace);
}

function trimStart(p) {
  return Comb$ReasonParse.keepLast(/* :: */[
...
function trimEnd(p) {
  return Comb$ReasonParse.keepFirst(/* :: */[
              p,
              /* :: */[
                RegExp$ReasonParse.maybeWhitespace,
                /* [] */0
...
describe("Comb", (function () {
        Jest.test("alt", (function () {
                ...
                var result = Comb$ReasonParse.seq(/* :: */[
                        (function (param) {
                            return Comb$ReasonParse.alt(partial_arg, param);
                          }),
                        /* :: */[
                          (function (param) {
                              return Comb$ReasonParse.alt(partial_arg$1, param);
                            }),
                          /* [] */0
                        ]
                      ])("abcd123");
        ...
        Jest.test("alt", (function () {
                ...
                var result = Comb$ReasonParse.many(/* Some */[1], /* None */0, (function (param) {
                          return Comb$ReasonParse.alt(partial_arg, param);
                        }))("abcd123*");
        ...
        Jest.test("trim", (function () {
                var result = Comb$ReasonParse.between(RegExp$ReasonParse.maybeWhitespace, RegExp$ReasonParse.digits, RegExp$ReasonParse.maybeWhitespace)("   0123     ");
                return Jest.Expect[/* toBe */2](/* true */1, Jest.Expect[/* expect */0](compareResults(result, /* `Success */[
                                    94326179,
                                    /* tuple */[
                                      /* `String */[
        ...
        Jest.test("sepBy, trimEnd", (function () {
                var partial_arg = (/^,/);
                var result = Comb$ReasonParse.sepBy(trimEnd((function (param) {
                            return RegExp$ReasonParse.regExp(partial_arg, param);
                          })), RegExp$ReasonParse.digit, "0, 1,  1, 2,35811");
                return Jest.Expect[/* toBe */2](/* true */1, Jest.Expect[/* expect */0](compareResults(result, /* `Success */[
                                    94326179,
        ...
        Jest.test("sepBy, trimStart", (function () {
                var partial_arg = (/^,/);
                var result = Comb$ReasonParse.sepBy(trimStart((function (param) {
                            return RegExp$ReasonParse.regExp(partial_arg, param);
                          })), RegExp$ReasonParse.digit, "0 ,1  ,1   ,2    ,35811");
                return Jest.Expect[/* toBe */2](/* true */1, Jest.Expect[/* expect */0](compareResults(result, /* `Success */[
                                    94326179,
        ...
        return Jest.test("betweenm, sepBy, trim", (function () {
                      var partial_arg = Comb$ReasonParse.between(RegExp$ReasonParse.maybeWhitespace, comma, RegExp$ReasonParse.maybeWhitespace);
                      var result = Comb$ReasonParse.between(Comb$ReasonParse.between(RegExp$ReasonParse.maybeWhitespace, lBrak, RegExp$ReasonParse.maybeWhitespace), (function (param) {
                                return Comb$ReasonParse.sepBy(partial_arg, RegExp$ReasonParse.digits, param);
                              }), Comb$ReasonParse.between(RegExp$ReasonParse.maybeWhitespace, rBrak, RegExp$ReasonParse.maybeWhitespace))(" [  01 ,   12   ,  12    ,  23    , 34]   5811");
                      return Jest.Expect[/* toBe */2](/* true */1, Jest.Expect[/* expect */0](compareResults(result, /* `Success */[
                                          94326179,
                                          /* tuple */[
                                            /* `List */[
