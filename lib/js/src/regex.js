  ...
  if (resultOption !== null) {
    ...
    if (match) {
      ...
      if (nullableString == null) {
        return /* Fail_ */Block.__(1, [Curry._1(Format.sprintf(/* Format */[
      ...
      return /* Fail_ */Block.__(1, ["Match not found -- captures array is empty."]);
    }
  } else {
    return /* Fail_ */Block.__(1, ["Match not found -- exec failed."]);
  }
}
