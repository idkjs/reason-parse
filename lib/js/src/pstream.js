...
function reduceWithIndexInternal(f, _init, _i, _list) {
  while(true) {
    var list = _list;
    var i = _i;
    var init = _init;
    if (list) {
      _list = list[1];
      _i = i + 1 | 0;
      _init = Curry._3(f, init, list[0], i);
      continue ;
...
function fold_lefti(f, init, list) {
  return List.fold_left((function (acc, i, a) {
                return Curry._2(f, acc, /* tuple */[
                            i,
                            a
                          ]);
              }), init, addRange(list));
...
exports.seq = seq;
exports.reduceWithIndexInternal = reduceWithIndexInternal;
