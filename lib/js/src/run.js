...
console.log(Node$ReasonParse.stringOfParseData(Pstream$ReasonParse.mergeParseData(List.split(results)[1])));

console.log(Node$ReasonParse.stringOfResult(Pstream$ReasonParse.seqqq(/* :: */[
              Regex$ReasonParse.letters,
              /* :: */[
                Regex$ReasonParse.digits,
                /* :: */[
...
var atoj = Pstream$ReasonParse.atLeast(10, Regex$ReasonParse.letter, "abcdefghijklmnopqrstuvwxyz12345");
